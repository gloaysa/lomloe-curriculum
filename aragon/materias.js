const materiasAragon = {
    ei: ['Todas las áreas'],
    ep1: ['Ciencias Sociales', 'Ciencias de la Naturaleza', 'Educación Física', 'Educación Plástica y Visual', 'Lengua Castellana y Literatura', 'Lengua Extranjera', 'Matemáticas', 'Música y Danza'],
    ep2: ['Ciencias Sociales', 'Ciencias de la Naturaleza', 'Educación Física', 'Educación Plástica y Visual', 'Lengua Castellana y Literatura', 'Lengua Extranjera', 'Matemáticas', 'Música y Danza'],
    ep3: ['Ciencias Sociales', 'Ciencias de la Naturaleza', 'Educación Física', 'Educación Plástica y Visual', 'Lengua Castellana y Literatura', 'Lengua Extranjera', 'Matemáticas', 'Música y Danza'],
    ep4: ['Ciencias Sociales', 'Ciencias de la Naturaleza', 'Educación Física', 'Educación Plástica y Visual', 'Lengua Castellana y Literatura', 'Lengua Extranjera', 'Matemáticas', 'Música y Danza'],
    ep5: ['Ciencias Sociales', 'Ciencias de la Naturaleza', 'Educación Física', 'Educación Plástica y Visual', 'Educación en Valores Cívicos y Éticos', 'Lengua Castellana y Literatura', 'Lengua Extranjera', 'Matemáticas', 'Música y Danza', 'Segunda Lengua Extranjera'],
    ep6: ['Ciencias Sociales', 'Ciencias de la Naturaleza', 'Educación Física', 'Educación Plástica y Visual', 'Educación en Valores Cívicos y Éticos', 'Lengua Castellana y Literatura', 'Lengua Extranjera', 'Matemáticas', 'Música y Danza', 'Segunda Lengua Extranjera'],
    eso1: [
        "Aragonés",
        "Catalán",
        "Biología y Geología",
